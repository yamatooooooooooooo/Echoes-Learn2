...
export class ProgressValidator {
  static validateProgressInput(progressData: ProgressFormData, subject: Subject): void {
  ...
  static validateQuickProgress(currentPage: number, newPage: number, totalPages: number): void {
