    ...
    return (
      <Grid container spacing={2}>
        <Grid item xs={12}>
          ...
          <Typography variant="body1">{formattedData.recordDate}</Typography>
        </Grid>
        ...
        <Grid item xs={4}>
          ...
          <Typography variant="body1">{formattedData.startPage}</Typography>
        </Grid>
        ...
        <Grid item xs={4}>
          ...
          <Typography variant="body1">{formattedData.endPage}</Typography>
        </Grid>
        ...
        <Grid item xs={4}>
          ...
          <Typography variant="body1">{formattedData.pagesRead} ページ</Typography>
        </Grid>
        ...
        {formattedData.studyDuration && formattedData.studyDuration > 0 && (
          <Grid item xs={12}>
            ...
            <Typography variant="body1">{formattedData.studyDuration} 分</Typography>
          </Grid>
        )}
        ...
        <Grid item xs={6}>
          ...
          <Typography variant="body2">{formattedData.createdAt}</Typography>
        </Grid>
        ...
        {formattedData.updatedAt && (
          <Grid item xs={6}>
            ...
            <Typography variant="body2">{formattedData.updatedAt}</Typography>
          </Grid>
        )}
      </Grid>
    );
...
export const ProgressDetailDialog = memo<ProgressDetailDialogProps>(
  ({ open, progress, onClose, formatDate }) => {
    if (!progress) {
      return null;
    }
