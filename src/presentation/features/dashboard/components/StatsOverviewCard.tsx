...
export const StatsOverviewCard: React.FC<StatsOverviewCardProps> = ({
  ...
  const weeklyQuotaStats = useMemo(() => {
    if (!Array.isArray(weeklyQuotas) || weeklyQuotas.length === 0)
      return { total: 0, completed: 0, rate: 0 };
          ...
          <Box display="flex" flexDirection="column" gap={3}>
                  ...
                  >
                    ...
                    <Box display="flex" alignItems="baseline" mb={1}>
                      <Typography
                        variant="h5"
                        fontWeight="bold"
                        color={getProgressColor(dailyQuotaStats.rate)}
                      >
                  ...
                  >
                    ...
                    <Box display="flex" alignItems="baseline" mb={1}>
                      <Typography
                        variant="h5"
                        fontWeight="bold"
                        color={getProgressColor(weeklyQuotaStats.rate)}
                      >
            ...
            <Box>
              ...
              <Box display="flex" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="body1">全 {totalSubjects} 科目</Typography>
                <Box>
                  <Chip
