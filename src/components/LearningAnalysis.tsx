...
import { AnalysisResult, AnalysisPeriod, AnalysisMetric, ChartDataPoint, AnalysisSummary } from '../domain/models/LearningAnalyticsModel';
    ...
    return (
      <Box mt={2}>
        ...
        <Grid container spacing={2}>
          <Grid item xs={6}>
            <Typography variant="body2" color="textSecondary">合計学習時間</Typography>
            <Typography variant="h6">{summary.totalStudyTime.toFixed(1)}分</Typography>
          </Grid>
          <Grid item xs={6}>
            <Typography variant="body2" color="textSecondary">平均学習時間</Typography>
            <Typography variant="h6">{summary.averageStudyTime.toFixed(1)}分/日</Typography>
          </Grid>
          <Grid item xs={6}>
            <Typography variant="body2" color="textSecondary">総ページ数</Typography>
            <Typography variant="h6">{summary.totalPages}ページ</Typography>
          </Grid>
          <Grid item xs={6}>
            <Typography variant="body2" color="textSecondary">最長連続学習</Typography>
